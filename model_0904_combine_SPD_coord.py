...
class Graphormer_0904(pl.LightningModule):
    ...
    def forward(self, batched_data, perturb=None):
        ...
        attn_bias, spd_rel_pos, x = batched_data.attn_bias, batched_data.rel_pos, batched_data.x
        ...
        ## TODO: combine spd with coords
        spd_rel_pos_bias = self.rel_pos_encoder(spd_rel_pos).permute(0, 3, 1, 2)
        rel_pos_bias = rel_pos_bias + spd_rel_pos_bias
